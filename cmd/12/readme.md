...
This is a list of how all the caves are connected. You start in the cave named `start`, and your destination is the cave
...
lowercase, like
`b`). It would be a waste of time to visit any small cave more than once, but big caves are large enough that it might
